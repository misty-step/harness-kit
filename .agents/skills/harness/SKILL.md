...
description: |
  ...
  shared doctrine, provider roster, harness configs, gates, evals, bootstrap,
  and sync logic. Use for "improve the harness", "tailor is wrong",
...
Mutate Spellbook's harness. Keep it thin.
